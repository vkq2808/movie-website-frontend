...
const CallbackContent = () => {
  ...
  useEffect(() => {
        ...
        if (response.success && response.data) {
          ...
          if (payment.payment_status === 'success') {
            ...
            toast.success('Payment Successful!', {
              description: `Amount ${payment.amount.toLocaleString()} ${payment.currency} has been added to your wallet.`,
            });
            ...
            if (vnpResponseCode === '00') {
              ...
              setStatus('success');
              toast.success('Payment Successful!', {
                description: 'Transaction is being processed. The amount will be updated to your wallet shortly.',
              });
              setTimeout(() => router.push('/wallet'), 3000);
            } else {
              setStatus('failed');
              toast.error('Payment Failed', {
                description: vnpResponseCode 
                  ? `Error code: ${vnpResponseCode}` 
    ...
    checkPaymentStatus();
  }, [paymentId, vnpResponseCode, router, toast]);
        ...
        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700 text-center">
          {loading || status === 'checking' ? (
            ...
            <>
              ...
              <h2 className="text-xl font-semibold mb-2 text-green-400">Payment Successful!</h2>
