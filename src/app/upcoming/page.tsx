...
function isFuture(dateStr?: string | null) {
    ...
    <div className="min-h-screen">
      ...
      <section className="relative isolate overflow-hidden bg-gradient-to-b from-gray-900 via-black to-gray-900">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute -top-24 left-1/2 -translate-x-1/2 h-72 w-[600px] rounded-full bg-blue-500/20 blur-3xl" />
        </div>
        <div className="relative z-10 container mx-auto px-4 py-10 md:py-14">
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white flex items-center gap-3">
              <CalendarDays className="h-8 w-8 text-blue-400" /> Upcoming Movies
            </h1>
            <p className="mt-3 text-base md:text-lg text-gray-300">
              Movies slated for release soon—mark your calendar.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-8">
        {loading && movies.length === 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No upcoming movies right now</h3>
