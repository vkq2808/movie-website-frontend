...
const EpisodesTab: React.FC<EpisodesTabProps> = ({ movie }) => {
  return (
    <div className="space-y-6">
      <h2 className="text-2xl font-bold text-white mb-6">Các bản chiếu</h2>
      ...
      <div className="space-y-4">
        <h3 className="text-xl font-semibold text-white">Danh sách tập</h3>
        ...
        <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-purple-600 rounded-lg flex items-center justify-center">
              <span className="text-white font-bold">Phụ đề</span>
            </div>
            <div className="flex-1">
              <h4 className="text-white font-medium">Full Movie</h4>
        ...
        <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h4 className="text-white font-medium">Full Movie (Dubbed)</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="text-white ml-2">
              {movie.vote_average?.toFixed(1) || '?'}/10 ({movie.vote_count || 0} votes)
            </span>
          </div>
